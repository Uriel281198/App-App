...
import walpaper.appchan.com.appchan.Model.WallpaperItem;
import walpaper.appchan.com.appchan.R;
import walpaper.appchan.com.appchan.ViewHolder.ListWallpaperViewHolder;
            ...
            protected void onBindViewHolder(@NonNull final ListWallpaperViewHolder holder, int position, @NonNull final WallpaperItem model) {
                            ...
                            public void onError() {
                                Picasso.with(getBaseContext())
                                        ...
                                        .into(holder.wallpaper, new Callback() {
                                            ...
                                            @Override
                                            public void onError() {
                                                Log.e ("SooyerDeveloper","Could not fetch image");
                                            }
                                        } );
                            }
                        });
                ...
                holder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position) {
                        Intent  intent = new Intent(ListImages.this,ViewWallpaper.class);
